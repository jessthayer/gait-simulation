%% SS 1
global icID subjID ss_predictionHorizon ds_predictionHorizon controlWindow timeStep...
...
for k = 1:22 %write subject parameters
    sdo.setValueInModel('ss1_inter',param.var(k),param.val(k))
end
...
load([sim_file_dir '\Param_' subjID])
for k = 1:22 %write subject parameters
    sdo.setValueInModel('ss1_plant',param.var(k),param.val(k))
end
