...
% obtain the dynamic effort optimization results
dynamicEffort = get(simulator.LoggedData,'Dynamic_Effort');
...
design.F = (vy_COM_target-vy_COM)^2*100000 + (vz_COM_target-vz_COM)^2*100000 + dynamicEffort %F — Value of the cost (objective) evaluated at p. The solver minimizes F.
